                    ...
                    <table class="table table-bordered table-striped table-sm" id="">
                        ...
                        <tbody>
                            ...
                            <div class="modal fade" id="modal-edit-{{$item->id}}" data-backdrop="static"
                                ...
                                aria-labelledby="modal-edit-{{$item->id}}Label" aria-hidden="true">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('item-update') }}">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input id="item" type="item"
                                                            class="form-control @error('item') is-invalid @enderror"
                                                            name="item" value="{{ $item->item }}" required
                                                ...
                                                <div class="form-group row">
                                                    <label for="description"
                                                        class="col-md-4 col-form-label text-md-right">{{ __('Extra decription') }}</label>
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('item-add') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input id="item" type="item" class="form-control @error('item') is-invalid @enderror"
                                name="item" value="{{ old('item') }}" required autocomplete="item" autofocus>
